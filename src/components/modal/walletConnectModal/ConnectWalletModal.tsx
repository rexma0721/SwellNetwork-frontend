...
const ConnectWalletModal: FC = () => {
  ...
  useEffect(() => {
    if (account && !previousAccount && isWalletModalOpen) {
      if (selectedNodeOperator === null) {
        closeWalletModal();
        dispatch(setIsNodeOperatorModalOpen(true));
      }
    }
  }, [account, previousAccount, closeWalletModal, isWalletModalOpen, dispatch, selectedNodeOperator]);
  ...
  function getModalContent() {
    ...
    return (
      ...
      >
        ...
        >
          By connecting a wallet, you agree to Swell Network’s <a href="#">Terms of Service</a> and acknowledge that you
          have read and understand the Swell Network <a href="#">Protocol Disclaimer</a>
        </Box>
