...
const Web3Status: FC<Props> = ({ sx, char, variant = 'default', onClick, onClickDropDown, ...props }) => {
  ...
  return (
    <Box
      ...
      sx={{
        ...
        borderColor: (theme) => (variant === 'outlined' ? theme.palette.grey[300] : '#fff'),
        ...sx,
      }}
    >
      {connector && <WrappedStatusIcon connector={connector} displayShowPortisButton={false} />}
      <Address onClick={onClick} sx={{ paddingLeft: connector ? 0 : '' }}>
